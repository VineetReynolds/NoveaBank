package org.jboss.examples.noveabank.accounting.services;

import org.jboss.examples.noveabank.accounting.model.*;
...
public class Journal {
    ...
    private Collection<JournalEntry> getPostedEntriesForAccountSince(Account account, Date dateTime) {
        String query = "SELECT j FROM JournalEntry j WHERE j.account = :account " +
                "AND j.postingStatus = org.jboss.examples.noveabank.accounting.model.PostingStatus.POSTED";
